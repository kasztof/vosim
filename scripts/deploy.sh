...
ssh root@92.222.69.244 cp /etc/vosim/.env /var/www/html/vosim
...
ssh root@92.222.69.244 docker build -t vosim_app /var/www/html/vosim/
ssh root@92.222.69.244 docker run -d -p 80:80 --name=vosim_app vosim_app